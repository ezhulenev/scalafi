...
import scalafi.garch.estimate.{Garch11Estimate, ArmaGarchLikelihood}
...
object LikelihoodTest extends App {
  ...
  println(llh3.likelihood(llh3.Parameters(DenseVector(1.0457e-04, 8.2335e-01, -2.3861e-02, -8.3632e-01, 1.3609e-06, 8.8059e-02, 9.0438e-01))))

  val spec4 = Spec(Arma(2, 1), Garch(2, 1))
  val llh4 = new ArmaGarchLikelihood(DenseVector(sp500: _*), spec4) {}
  println(llh4.likelihood(llh4.Parameters(DenseVector(1.0443e-04, 8.2354e-01, -2.3827e-02, -8.3653e-01, 1.3594e-06, 8.7986e-02, 1.0000e-08, 9.0445e-01))))
